...
function Card4() {
 ...
 <div className="w-full h-fit relative  bg-light-background  dark:bg-dark-secondarybg    shadow-md rounded-xl cursor-pointer">
      ...
      >
        ...
        <div className=" w-full  absolute   flex   2xl:mt-[-1rem]  pr-[1rem] justify-end items-center ">
          <button className="  font-normal text-T11  w-fit  px-5  rounded-lg py-[3px]   bg-light-button-base   text-white   font-poppins">
            {" "}
            Popular
          </button>
        </div>
        ...
        >
          ...
          <div className="w-full p-4">
            <button
              className={`text-white font-semibold font-poppins text-lg text-center py-[12px] rounded-lg w-full ${buttonConfig.bgClass}`}
            >
              {isLoadingBtn ? (
