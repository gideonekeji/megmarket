...
function BusinessService() {
  ...
  const handleCardClick = () => {
    ...
    router.push(`/bussines/services/${service_name.toLowerCase().replace(/\s+/g, "-")}`);
  };

  return (
    <>
        <div
          className={`mx-auto  2xl:w-[68%]  w-[90%]   gap-5 rounded-xl xl:rounded-3xl py-6 xl:py-[2rem] 6 px-6 md:px-12 flex justify-between items-center cursor-pointer  ${isDarkMode
