...
import addprofile from "../../../../../public/assets/Image/socail.png";
...
const Demo = Cookies.get("demoUser") === "true";
  ...
  return (
    ...
    >
      <div className="w-[6rem]  h-[6rem]  rounded-lg  flex justify-center items-center  bg-[#B7FDF7]  ">
        <Image
          src={addprofile}
          alt="edit profile"
      ...
      >
        <p> {getTranslation("Add Social ", "Add Social ")} </p>
        <p> {getTranslation("Links ", "Links")} </p>
      </div>
    </div>
  );
}
