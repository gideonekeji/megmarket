...
function BusinessTimings() {
  ...
  return (
    ...
    >
      <div className=" w-[6rem]  h-[6rem] rounded-lg  flex justify-center items-center  bg-[#E6DCFF]  ">
        <Image
          src={addprofile}
          alt="edit profile"
      ...
      >
        <p> {getTranslation("Business", "Business")} </p>
        <p> {getTranslation("Timings", "Timings")} </p>
      </div>
    </div>
  );
}
