...
function CustomeSupport() {
  ...
  const handleCardClick = () => {
    ...
    router.push(`/bussines/support/${service_name.toLowerCase().replace(/\s+/g, "-")}`);
  };
  return (
    <>
      <div
      ...
      >
        ...
        <div className="flex justify-start items-center gap-6">
          ...
          <div className=" w-full flex-col flex  gap-[14px] ">
            <h3 className="text-lg font-medium font-poppins     2xl:text-H6 ">      {getTranslation("Support", "Support")}</h3>
            <p className="text-[#B4B4B4]  xl:text-T3 font-poppins font-normal  ">
              {getTranslation("Connect with Us", "Connect with Us")}
            </p>
          </div>
        </div>
        {/* Right Side */}
